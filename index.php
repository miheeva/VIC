	...
	?>
                                    ...
                                    <div class="media">
                                      <div class="media-left" href="#">
                                          <h3 class="media-object"><?php the_time('j'); ?></h3>
                                        </div>
                                      <div class="media-body">
                                        <h4 class="media-heading"><?php the_time('F'); ?></h4>
                                        <h4 class="media-heading"><span><?php the_time('Y'); ?></span></h4>
                                      </div>
                                        </div>
                                        <h3><?php the_title() ?></h3>
                                        <p><?php the_excerpt();?></p>
...
if( $query->have_posts() ){
	...
	?>	
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 project">
                        ...
                        <p class="text-project"><?php the_excerpt();?></p>
                    </div>
                    <?php
	}
